...
const Home = () => {
  ...
  const wordsComponents = [
    ...
    <div className="flex flex-col items-center mb-4 sm:mb-6 md:mb-8 lg:mb-10">
      <p className="text-5xl sm:text-7xl md:text-9xl lg:text-11xl font-bold">Iam</p>
      <p className="text-6xl sm:text-8xl md:text-10xl lg:text-12xl font-bold">Edwin PT</p>
    </div>,
    <div className="flex flex-col items-center mb-4 sm:mb-6 md:mb-8 lg:mb-10">
      <p className="text-4xl sm:text-6xl md:text-8xl lg:text-10xl font-bold">Expirinced</p>
      <p className="text-6xl sm:text-8xl md:text-10xl lg:text-12xl font-bold">MERN</p>
      <p className="text-4xl sm:text-6xl md:text-8xl lg:text-10xl font-bold">stack devleoper</p>
    </div>
  ]
